...
// StreePathGet 带参数查询一条记录函数 level=3 and path=/0
...
// StreePathAddTest 编写新增node的测试函数
...
// StreePathQueryTest1 编写查询node的测试函数
...
// StreePathQueryTest2 编写查询node的测试函数 type=2
...
// StreePathQueryTest3 编写查询node的测试函数 type=3
...
// StreePathDelTest 编写删除node的测试函数
