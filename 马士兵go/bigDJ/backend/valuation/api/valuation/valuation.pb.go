...
const file_api_valuation_valuation_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/valuation/valuation.proto\x12\rapi.valuation\"O\n" +
	...
	"\x05price\x18\x03 \x01(\x03R\x05price2i\n" +
	"\tValuation\x12\\\n" +
	"\x10GetEstimatePrice\x12\".api.valuation.GetEstimatePriceReq\x1a$.api.valuation.GetEstimatePriceReplyB#Z!valuation/api/valuation;valuationb\x06proto3"

var (
	file_api_valuation_valuation_proto_rawDescOnce sync.Once
	file_api_valuation_valuation_proto_rawDescData []byte
)

func file_api_valuation_valuation_proto_rawDescGZIP() []byte {
	file_api_valuation_valuation_proto_rawDescOnce.Do(func() {
		file_api_valuation_valuation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_valuation_valuation_proto_rawDesc), len(file_api_valuation_valuation_proto_rawDesc)))
	})
...
func file_api_valuation_valuation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_valuation_valuation_proto_rawDesc), len(file_api_valuation_valuation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
